# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in proloco.
...
base_config.update_blueprint({
    'use_sqlalchemy': True,
    'model': proloco.model,
    'DBSession': proloco.model.DBSession,
})
...
base_config.update_blueprint({
    ...
    'sa_auth.cookie_secret': "22a6679b-c403-4bdd-b42c-158e062a03d3",
